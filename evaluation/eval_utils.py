# Adapted from https://github.com/princeton-nlp/ALCE/main/eval.py
...
def load_model(model_name_or_path, dtype=torch.float16, int8=False, reserve_memory=10, quantize=False, inference=True):
    ...
    if quantize:
        ...
        logger.warn("Adopting 4 bit quantization with {} compute type".format(compute_type))
