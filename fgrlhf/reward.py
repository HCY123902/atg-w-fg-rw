...
class BasicReward(metaclass=abc.ABCMeta):
    ...
    def kl_penalize_reward(self, results):
        ...
        # The kl here is measured in terms of the distance between the model at the current step before running the ppo epoch in the batch and the initial model after supervised training
